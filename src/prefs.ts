...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    resonanceSearch: 'Resonance',
    resonanceSeries: 'series',
    resonanceParallel: 'parallel',
    resonanceNotAvailable: 'Resonance: N/A (no zero-crossing in data)',
  ...
  es: {
    ...
    resonanceSearch: 'Resonancia',
    resonanceSeries: 'serie',
    resonanceParallel: 'paralelo',
    resonanceNotAvailable: 'Resonancia: N/D (sin cruce por cero en los datos)',
